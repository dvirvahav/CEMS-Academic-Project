...
/**
 * <p>
 * <b>Explanation:</b> The class attachQuestion controller is the second frame
 * of "compose an exam" frame.
 * <p>
 * The class allows the teacher to select a question, set the number of points
 * to the question, and present to the teacher the remaining points for the
 * exam.
 * <p>
 * The teacher can click 'done' and return to compose an exam frame with the
 * chosen question or 'back' to the same screen without the chosen question.
 * <p>
 * 
 * @author OrSteiner
 */
public class AttachQuestionController 
{
	...
	/**
	 * <p>
	 * <b>Explanation:</b> The method gets the questions from the previous screen
	 * and present them to the teacher.
	 * <p>
	 * <b>Receive:</b> The method gets array list of questions and the points the
	 * were summed until now for a test.
	 * <p>
	...
	/**
	 * <p>
	 * <b>Explanation:</b> The method create a Question in exam object to place in
	 * the list of the previous frame.
	 * <p>
	 * She use flag that determines wether question is already in the exam, then she
	 * get the selected question from table view and if there are any miss fields
	 * she pop the error screen.
	 * <p>
	 * In advance, she store all the errors in errorLog
	 * <p>
	 * At the end, if all fields are filled create QuestionInExam object with the
	 * user parameters and send them to the previous frame
	 * <p>
	...
	{
		// flag that determines whether question is already in the exam
		...
		else 
		{
			...
			// if question is already in exam turn on isInExam flag
			...
			if (isInExam == false) 
			{
				...
				QuestionInExam questionToSend = new QuestionInExam(questionToAttach, points, " ", " ", null);
	...
	/**
	 * <p>
	 * <b>Explanation:</b> The method create a call for Compose an exam frame with
	 * the question to send.
	 * <p>
	 * <b>Receive:</b> The method gets question to return and the event 'click' on
	 * send a question button.
	 * <p>
	 * <b>Return:</b> The method does not return anything.
	 * <p>
	 * 
	...
	/**
	 * <p>
	 * <b>Explanation:</b> The method swap the scene back to the last scene-compose
	 * an exam, when we click the button 'back'.
	 * <p>
